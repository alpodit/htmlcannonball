...
function sortBallPos(x, y) {
    ...
    //These values can be hardcoded because the cannon is always in the same position
    ...
    let newX = (cannon.x + 15) + 
        distance * Math.cos(originalAngle + rotatedAngle);
    let newY = (cannon.y - 50) + 
        distance * Math.sin(originalAngle + rotatedAngle);
